...
def deformable_attn_pytorch_3d(
    ...
    H_, W_, NF_ = value_spatial_shapes
    # bs, NF_*H_*W_, num_heads, embed_dims ->
    # bs, NF_*H_*W_, num_heads*embed_dims ->
    # bs, num_heads*embed_dims, NF_*H_*W_ ->
    # bs*num_heads, embed_dims, NF_*H_, W_
    ...
    # bs*num_heads, num_queries, num_points, 3
    sampling_grids = sampling_grids.transpose(1, 2).reshape(bs*num_heads, 1, num_queries, num_points, 3)
    # bs*num_heads, embed_dims, 1, num_queries, num_points ->
